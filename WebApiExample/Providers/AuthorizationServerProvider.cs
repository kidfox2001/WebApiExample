...
namespace WebApiExample.Providers
{
    public class AuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        {
            //// validate user และทำการเก็บ user detail ใส่ claim 
        ...
        {
            // ไว้ใส่ property ของ response ออกไปให้เห็นเลย
        ...
        {
            // คล้ายส่วนของ GrantResourceOwnerCredentials และทำการเพิ่ม ClaimsIdentity เพิ่มเติมได้
